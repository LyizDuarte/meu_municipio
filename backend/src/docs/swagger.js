const swaggerDocument = {
  ...
  components: {
    ...
    schemas: {
      ...
      PostCreateRequest: {
        type: 'object',
        required: ['id_categoria', 'id_cidade', 'tipo_post', 'titulo', 'descricao'],
        properties: {
      ...
      PostUpdateRequest: {
        ...
        properties: {
          titulo: { type: 'string' },
          descricao: { type: 'string' },
          status_post: { type: 'string', enum: ['aberto', 'em_analise', 'resolvido', 'arquivado'] },
  ...
  paths: {
    ...
    '/auth/me': {
      get: {
        ...
        security: [{ bearerAuth: [] }],
        responses: {
          200: { description: 'Dados do usuário', content: { 'application/json': { schema: { type: 'object' } } } },
          401: { description: 'Token não fornecido ou inválido', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    },
    '/posts': {
      get: {
        ...
        parameters: [
          { name: 'tipo_post', in: 'query', schema: { type: 'string', enum: ['sugestao', 'reclamacao'] } },
          { name: 'id_categoria', in: 'query', schema: { type: 'integer' } },
          { name: 'id_cidade', in: 'query', schema: { type: 'integer' } },
          { name: 'page', in: 'query', schema: { type: 'integer', default: 1 } },
          { name: 'limit', in: 'query', schema: { type: 'integer', default: 10 } },
          { name: 'sort', in: 'query', schema: { type: 'string', enum: ['recentes', 'populares'] } },
        ],
        responses: {
          200: {
      ...
      post: {
        ...
        responses: {
          201: {
            ...
            content: { 'application/json': { schema: { type: 'object', properties: { message: { type: 'string' }, post: { type: 'object' } } } } },
          },
          400: { description: 'Validação falhou', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
    ...
    '/posts/{id}': {
      get: {
        ...
        responses: {
          200: { description: 'Detalhes do post', content: { 'application/json': { schema: { $ref: '#/components/schemas/PostDetailResponse' } } } },
          404: { description: 'Post não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
      put: {
        tags: ['Posts'],
        ...
        security: [{ bearerAuth: [] }],
        parameters: [ { name: 'id', in: 'path', required: true, schema: { type: 'integer' } } ],
        requestBody: { required: true, content: { 'application/json': { schema: { $ref: '#/components/schemas/PostUpdateRequest' } } } },
        responses: {
          200: { description: 'Post atualizado', content: { 'application/json': { schema: { type: 'object' } } } },
          400: { description: 'Validação falhou', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
      ...
      delete: {
        ...
        parameters: [ { name: 'id', in: 'path', required: true, schema: { type: 'integer' } } ],
        responses: {
          200: { description: 'Post deletado', content: { 'application/json': { schema: { type: 'object', properties: { message: { type: 'string' } } } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          403: { description: 'Sem permissão', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          404: { description: 'Post não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
    ...
    '/posts/my/posts': {
      get: {
        ...
        responses: {
          200: { description: 'Lista de posts do usuário', content: { 'application/json': { schema: { type: 'object' } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    },
    ...
    '/posts/{id}/comments': {
      get: {
        ...
        responses: {
          200: { description: 'Lista de comentários', content: { 'application/json': { schema: { $ref: '#/components/schemas/CommentsListResponse' } } } },
        },
      },
      post: {
        tags: ['Comments'],
        ...
        responses: {
          201: { description: 'Comentário adicionado', content: { 'application/json': { schema: { type: 'object' } } } },
    ...
    '/posts/{id}/comments/{commentId}': {
      delete: {
        ...
        responses: {
          200: { description: 'Comentário removido', content: { 'application/json': { schema: { type: 'object', properties: { message: { type: 'string' } } } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          404: { description: 'Comentário não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    },
    '/posts/{id}/support': {
      post: {
        ...
        security: [{ bearerAuth: [] }],
        parameters: [ { name: 'id', in: 'path', required: true, schema: { type: 'integer' } } ],
        requestBody: { required: false, content: { 'application/json': { schema: { $ref: '#/components/schemas/SupportRequest' } } } },
        responses: {
          200: { description: 'Apoio registrado', content: { 'application/json': { schema: { type: 'object' } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          404: { description: 'Post não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
      delete: {
        ...
        parameters: [ { name: 'id', in: 'path', required: true, schema: { type: 'integer' } } ],
        responses: {
          200: { description: 'Apoio removido', content: { 'application/json': { schema: { type: 'object' } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          404: { description: 'Post não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
    ...
    '/posts/{id}/share': {
      post: {
        ...
        parameters: [ { name: 'id', in: 'path', required: true, schema: { type: 'integer' } } ],
        responses: {
          200: { description: 'Compartilhamento registrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ShareResponse' } } } },
          401: { description: 'Não autenticado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
          404: { description: 'Post não encontrado', content: { 'application/json': { schema: { $ref: '#/components/schemas/ErrorResponse' } } } },
        },
      },
